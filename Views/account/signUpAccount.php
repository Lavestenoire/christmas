...
<div id="signUpForms">
    <section>
        ...
        <form class="mx-auto w-80" action="signUpAccount" method="POST">
            ...
            <?php
            if (isset($_SESSION['error_messageAccount'])) : ?>
                <div class="text-danger"><?= ($_SESSION['error_messageAccount']) ?></div>
            <?php endif;
    ...
    <section>
        ...
        <form class="mx-auto w-80" action="signUpUser" method="POST">
            <div class="mb-3 col-5">
                ...
                <?php if (isset($error['nickname_user'])) : ?>
                    <div class="text-danger"><?= ($error['nickname_user']) ?></div>
                <?php endif; ?>
            </div>
            <div class="mb-3 col-5">
                <label for="email_user" class="form-label">Email</label>
                <input type="email" name="email_user" class="form-control" id="email_user" aria-describedby="usernameHelp" required>
                <?php if (isset($error['email_user'])) : ?>
                    <div class="text-danger"><?= ($error['email_user']) ?></div>
                <?php endif; ?>
            </div>
            <div class="mb-3 col-5 mdp">
                <div class="eye"><i class="fa-regular fa-eye"></i></div>
                ...
                <?php if (isset($error['password_user'])) : ?>
                    <div class="text-danger"><?= ($error['password_user']) ?></div>
                <?php endif; ?>
            </div>
            <div class="mb-3 col-5 mdp">
                <div class="eye"><i class="fa-regular fa-eye"></i></div>
            ...
            <?php
            if (isset($_SESSION['error_messageUser'])) : ?>
                <div class="text-danger"><?= ($_SESSION['error_messageUser']) ?></div>
            <?php endif;
